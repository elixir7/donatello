...
#define IS_LL_ADC_COMMON_CLOCK(__CLOCK__)                                                                              \
    (((__CLOCK__) == LL_ADC_CLOCK_SYNC_PCLK_DIV2) || ((__CLOCK__) == LL_ADC_CLOCK_SYNC_PCLK_DIV4)                      \
     || ((__CLOCK__) == LL_ADC_CLOCK_SYNC_PCLK_DIV6) || ((__CLOCK__) == LL_ADC_CLOCK_SYNC_PCLK_DIV8))
...
#define IS_LL_ADC_REG_TRIG_SOURCE(__REG_TRIG_SOURCE__)                                                                 \
    (((__REG_TRIG_SOURCE__) == LL_ADC_REG_TRIG_SOFTWARE) || ((__REG_TRIG_SOURCE__) == LL_ADC_REG_TRIG_EXT_TIM1_CH1)    \
...
#define IS_LL_ADC_INJ_TRIG_SOURCE(__INJ_TRIG_SOURCE__)                                                                 \
    (((__INJ_TRIG_SOURCE__) == LL_ADC_INJ_TRIG_SOFTWARE) || ((__INJ_TRIG_SOURCE__) == LL_ADC_INJ_TRIG_EXT_TIM1_CH4)    \
...
#define IS_LL_ADC_MULTI_MODE(__MULTI_MODE__)                                                                           \
    (((__MULTI_MODE__) == LL_ADC_MULTI_INDEPENDENT) || ((__MULTI_MODE__) == LL_ADC_MULTI_DUAL_REG_SIMULT)              \
     || ((__MULTI_MODE__) == LL_ADC_MULTI_DUAL_REG_INTERL) || ((__MULTI_MODE__) == LL_ADC_MULTI_DUAL_INJ_SIMULT)       \
     ...
     || ((__MULTI_MODE__) == LL_ADC_MULTI_TRIPLE_INJ_SIMULT) || ((__MULTI_MODE__) == LL_ADC_MULTI_TRIPLE_REG_SIMULT)   \
...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef* ADCx) {
    ...
    if (READ_BIT(ADCx->CR2, ADC_CR2_ADON) == 0UL) {
        ...
        CLEAR_BIT(
            ADCx->SR,
            (LL_ADC_FLAG_STRT | LL_ADC_FLAG_JSTRT | LL_ADC_FLAG_EOCS | LL_ADC_FLAG_OVR | LL_ADC_FLAG_JEOS
             | LL_ADC_FLAG_AWD1)
        );
        ...
        CLEAR_BIT(
            ADCx->CR1,
            (ADC_CR1_OVRIE | ADC_CR1_RES | ADC_CR1_AWDEN | ADC_CR1_JAWDEN | ADC_CR1_DISCNUM | ADC_CR1_JDISCEN
             | ADC_CR1_DISCEN | ADC_CR1_JAUTO | ADC_CR1_AWDSGL | ADC_CR1_SCAN | ADC_CR1_JEOCIE | ADC_CR1_AWDIE
        ...
        CLEAR_BIT(
            ADCx->CR2,
            (ADC_CR2_SWSTART | ADC_CR2_EXTEN | ADC_CR2_EXTSEL | ADC_CR2_JSWSTART | ADC_CR2_JEXTEN | ADC_CR2_JEXTSEL
             | ADC_CR2_ALIGN | ADC_CR2_EOCS | ADC_CR2_DDS | ADC_CR2_DMA | ADC_CR2_CONT | ADC_CR2_ADON)
        );

        /* Reset register SMPR1 */
        CLEAR_BIT(
            ADCx->SMPR1,
            (ADC_SMPR1_SMP18 | ADC_SMPR1_SMP17 | ADC_SMPR1_SMP16 | ADC_SMPR1_SMP15 | ADC_SMPR1_SMP14 | ADC_SMPR1_SMP13
        ...
        /* Reset register SQR2 */
        CLEAR_BIT(
            ADCx->SQR2, (ADC_SQR2_SQ12 | ADC_SQR2_SQ11 | ADC_SQR2_SQ10 | ADC_SQR2_SQ9 | ADC_SQR2_SQ8 | ADC_SQR2_SQ7)
        );

        /* Reset register SQR3 */
        CLEAR_BIT(
            ADCx->SQR3, (ADC_SQR3_SQ6 | ADC_SQR3_SQ5 | ADC_SQR3_SQ4 | ADC_SQR3_SQ3 | ADC_SQR3_SQ2 | ADC_SQR3_SQ1)
        );
...
ErrorStatus LL_ADC_Init(ADC_TypeDef* ADCx, LL_ADC_InitTypeDef* ADC_InitStruct) {
    ...
    if (LL_ADC_IsEnabled(ADCx) == 0UL) {
        ...
        MODIFY_REG(
            ADCx->CR1, ADC_CR1_RES | ADC_CR1_SCAN, ADC_InitStruct->Resolution | ADC_InitStruct->SequencersScanMode
        );
...
ErrorStatus LL_ADC_REG_Init(ADC_TypeDef* ADCx, LL_ADC_REG_InitTypeDef* ADC_REG_InitStruct) {
    ...
    if (LL_ADC_IsEnabled(ADCx) == 0UL) {
        ...
        MODIFY_REG(
            ...
            (ADC_REG_InitStruct->TriggerSource & ADC_CR2_EXTSEL) | ADC_REG_InitStruct->ContinuousMode
